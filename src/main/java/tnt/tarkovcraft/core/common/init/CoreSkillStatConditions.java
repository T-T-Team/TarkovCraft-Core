...
public final class CoreSkillStatConditions {
    ...
    public static final DeferredRegister<SkillStatConditionType<?>> REGISTRY = DeferredRegister.create(CoreRegistries.Keys.SKILL_STAT_CONDITION_TYPE, TarkovCraftCore.MOD_ID);
