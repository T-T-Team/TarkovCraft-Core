...
public final class CoreSkillTriggerEvents {
    ...
    public static final DeferredRegister<SkillTriggerEvent> REGISTRY = DeferredRegister.create(CoreRegistries.Keys.SKILL_TRIGGER_EVENT, TarkovCraftCore.MOD_ID);
