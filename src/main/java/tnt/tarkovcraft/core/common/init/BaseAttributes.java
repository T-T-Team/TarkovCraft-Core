...
public final class BaseAttributes {
    ...
    public static final Holder<Attribute> LEG_ENERGY_CONSUMPTION_MULTIPLIER = REGISTRY.register("leg_energy_consumption_multiplier", location -> Attribute.create(location, 1));
    public static final Holder<Attribute> LEG_ENERGY_RECOVERY = REGISTRY.register("leg_energy_recovery", location -> Attribute.create(location, 0.5));
}
