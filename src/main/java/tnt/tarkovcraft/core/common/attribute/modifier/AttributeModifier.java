...
public abstract class AttributeModifier {
    ...
    protected AttributeModifier(ResourceLocation identifier) {
        this.identifier = identifier;
    }

    public static SetValueAttributeModifier set(ResourceLocation identifier, double value) {
        return new SetValueAttributeModifier(identifier, value);
    }

    public static AddValueModifier add(ResourceLocation identifier, double value) {
        return new AddValueModifier(identifier, value);
    }

    public static AddValueModifier subtract(ResourceLocation identifier, double value) {
        return new AddValueModifier(identifier, -value);
    }

    public static MultiplyValueAttributeModifier multiplier(ResourceLocation identifier, double multiplier) {
        return new MultiplyValueAttributeModifier(identifier, multiplier);
    }

    public static MultiplyValueAttributeModifier multiplyBase(ResourceLocation identifier, double multiplier) {
    ...
    public static <A extends AttributeModifier> Products.P1<RecordCodecBuilder.Mu<A>, ResourceLocation> codec(RecordCodecBuilder.Instance<A> instance) {
        return instance.group(
                ResourceLocation.CODEC.fieldOf("id").forGetter(AttributeModifier::identifier)
        );
    }
}
