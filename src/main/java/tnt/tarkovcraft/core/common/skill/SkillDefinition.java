...
public record SkillDefinition(ResourceLocation identifier, Component displayName, SkillCategory category, SkillConfiguration configuration, List<SkillTriggerDefinition> triggers, List<SkillBonusDefinition> bonuses) {

    public static final Codec<SkillDefinition> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ResourceLocation.CODEC.fieldOf("identifier").forGetter(SkillDefinition::identifier),
