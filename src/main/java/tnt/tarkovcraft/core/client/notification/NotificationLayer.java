...
public class NotificationLayer implements GuiLayer {
    ...
    public static void drawNotifications(GuiGraphicsExtractor graphics, Font font, int windowWidth, int windowHeight, NotificationChannel channel, int maxWidth) {
