...
public class SkillScreen extends CharacterSubScreen {
    ...
    public static final class SkillWidget extends AbstractWidget {
        ...
        private final class BonusBadgeInfo {
            ...
            void extractRenderState(GuiGraphics graphics, Font font, int x1, int y1, int mouseX, int mouseY) {
                int x2 = x1 + 10;
                int y2 = y1 + 10;
                ...
                if (MathHelper.isWithinBounds(mouseX, mouseY, x1, y1, x2 - x1, y2 - y1)) {
                    SkillWidget.this.parent.setTooltipForNextRenderPass(RenderUtils.splitTooltip(this.tooltip, font));
                }
            }
        }
    }
